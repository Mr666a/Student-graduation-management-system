...
import com.hack.graduation_project_system.domain.TeacherExample.Criteria;
import com.hack.graduation_project_system.domain.TeacherExample.Criterion;
...
public class TeacherSqlProvider {
    ...
    public String insertSelective(Teacher record) {
        ...
        if (record.getTeacherid() != null) {
            VALUES("teacherId", "#{teacherid,jdbcType=INTEGER}");
        }
        
        if (record.getTeachername() != null) {
            VALUES("teacherName", "#{teachername,jdbcType=VARCHAR}");
        }
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ...
        if (record.getTeachername() != null) {
            SET("teacherName = #{record.teachername,jdbcType=VARCHAR}");
        }
